...
export async function POST(request: NextRequest) {
  ...
  if (!featureCheck.allowed) {
    return new Response(
      JSON.stringify({ success: false, error: featureCheck.message, code: featureCheck.code, requiredPlan: featureCheck.requiredPlan }),
  ...
  if (!quotaCheck.allowed) {
    return new Response(
      JSON.stringify({ success: false, error: quotaCheck.message, code: quotaCheck.code, quota: { key: quotaCheck.key, current: quotaCheck.current, limit: quotaCheck.limit } }),
